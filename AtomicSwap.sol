...
/* This contract is based on https://github.com/AltCoinExchange/ethatomicswap/blob/master/contracts/AtomicSwap.sol
   ...
   For two ETH-based chains, this contract allows two persons safely exchange assets without trusting each other. All ERC20 and ERC721 tokens are supported.
